...
class ReplaceTestCase(unittest.TestCase):
    ...
    def _highest_count_synonym(self):
        test1 = ['inhibition', 'inhibition', 'suppression', 'inhibition', 'inhibition', 'prohibition', 'inhibition', 'forbiddance']
    ...
    def test_dictCreate(self):
        ...
        counter = {'evaluation': 2, 'dye': 2, 'exclusion': 2, 'colony': 8, 'settlement': 15, 'inhibition': 17, 'prohibition': 50}
        expected_dictionary = {'inhibition': 'prohibition', 'settlement': 'settlement', 'colony': 'settlement', 'exclusion': 'exclusion',
